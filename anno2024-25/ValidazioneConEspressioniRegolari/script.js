function valida() {
   ...
   if (!espr_vali2.test(cap)) { 
      alert("Devi inserire un cap valido - stringa formata di soli 5 caratteri numerici");
   ...
   if (!espr_vali3.test(email) || !email) {
   ...
   if (test1 && test2 && test3 && test4 && test5 && test6 && test7 && test8 && test9 && test10) {
      ...
      window.location.href = "https://rubinomatteo.github.io/lavoriScuola/anno2024-25/ValidazioneConEspressioniRegolari/destinazione.html";
   }
